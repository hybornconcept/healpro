...
<Card.Root>
	<Card.Header class="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
		<div class="flex flex-1 flex-col justify-center gap-1 px-6 py-3 sm:py-4">
		...
		<div class="flex">
			{#each ['telemedicine', 'inPerson'] as key (key)}
				...
				<button
					...
					class="data-[active=true]:bg-muted/50 relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-2 text-left even:border-l sm:border-t-0 sm:border-l sm:px-8 sm:py-4"
	...
	<Card.Content class="px-2 sm:p-4">
